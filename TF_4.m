img = imread('C:\Users\rose_\Desktop\MARI\9_NONO\IPI\TRABALHOS\TF/ovitrampa13.jpg');
...
% MÉTODO 1 / MÉTODO 2
YIQ13(:,:,1) = (0.299.*(img(:,:,1)) + 0.587.*(img(:,:,2)) + 0.114.*(img(:,:,3)));
YIQ13(:,:,2) = (0.596.*(img(:,:,1)) - 0.274.*(img(:,:,2)) - 0.322.*(img(:,:,3)));
YIQ13(:,:,3) = (0.211.*(img(:,:,1)) - 0.523.*(img(:,:,2)) + 0.312.*(img(:,:,3)));
